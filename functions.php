...
function university_files() {
   wp_enqueue_script('googleMap', '//maps.googleapis.com/maps/api/js?key=AIzaSyADPcSoDDOj_8RWbS7N8tRZ7L7bDrewO5c', NULL, '1.0', true);
...
$api['key'] = 'AIzaSyADPcSoDDOj_8RWbS7N8tRZ7L7bDrewO5c';
return $api;
}
